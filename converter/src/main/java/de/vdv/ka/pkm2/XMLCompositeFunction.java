...
/**
 * <p>Java-Klasse für XML-CompositeFunction complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="XML-CompositeFunction"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://vdv/ka/pkm/2}XML-CommonFunction"&gt;
...
@XmlType(name = "XML-CompositeFunction")
@XmlSeeAlso({
    XMLFunctionValue.class
})
@Generated(value = "com.sun.tools.xjc.Driver", comments = "JAXB RI v3.0.0", date = "2022-02-14T02:39:27+01:00")
public class XMLCompositeFunction
    extends XMLCommonFunction
{

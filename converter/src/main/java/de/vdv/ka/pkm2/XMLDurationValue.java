...
/**
 * <p>Java-Klasse für XML-DurationValue complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="XML-DurationValue"&gt;
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;http://vdv/ka/pkm/2&gt;XML-DurationContent"&gt;
 *     &lt;/extension&gt;
 *   &lt;/simpleContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "XML-DurationValue", propOrder = {
    "value"
})
